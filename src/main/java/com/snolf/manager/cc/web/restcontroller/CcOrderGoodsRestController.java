...
@Controller
@RequestMapping("/manager/cc/rest/orderGoods")
public class CcOrderGoodsRestController extends BaseController {

	@Resource
	private CcMemberService ccMemberService;

	@RequiresPermissions("/manager/cc/rest/orderGoods/list")
	 ...
	 * @return
	 */
	@RequiresPermissions("/manager/cc/rest/orderGoods/get")
	@RequestMapping("get")
	@ResponseBody
	...
	@RequiresPermissions("/manager/cc/rest/orderGoods/add")
	...
	@RequiresPermissions("/manager/cc/rest/orderGoods/edit")
	...
	@RequiresPermissions("/manager/cc/rest/orderGoods/delete")
