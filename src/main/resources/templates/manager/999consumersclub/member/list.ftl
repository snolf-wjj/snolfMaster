...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 消费商中心 <span class="c-gray en">&gt;</span> 消费商管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div id="app" class="page-container">
	<div class="text-c"> 日期范围：
		...
		<input type="text" class="input-text" style="width:250px" placeholder="输入消费商名称" id="name" v-model="name">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="javascript:;" @click="add('添加','${base}/manager/cc/member/add.html','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a>
		</span>
			...
			<tbody>
				...
				<tr class="text-c" v-for="data in dataList">
					...
					<td class="td-manage">
						...
						<a title="编辑" href="javascript:;" v-on:click="edit('编辑','${base}/manager/cc/member/edit.html',data.id,'','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
var app = new Vue({
    ...
    methods: {
        loadData: function(pageNum) {
            ...
            layer.load();
            this.$http.get("${base}/manager/cc/rest/member/list",{params:{"pageNum": this.pageNum, "name": this.name,
		...
		del: function(obj, id) {
            layer.confirm('确认要删除吗？',function() {
                Vue.http.post("${base}/manager/cc/rest/member/delete", {"id":id}, {emulateJSON:true}).then(function(response) {
                    var data = response.data;
                    if ("0000" == data.code) {
                        layer.msg(data.msg, {icon: 1, time: 1000});
                        app.loadData(1);
