...
<article class="page-container" id="app">
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>部门级别：</label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="remark" cols="" rows="" class="textarea" v-model="dept.remark" placeholder="说点什么..." onkeyup="$(this).Huitextarealength()"></textarea>
            </div>
        </div>
        <div class="row cl">
    ...
    var app = new Vue({
        ...
        methods: {
            getDeptTree: function() {
                this.$http.get("${base}/system/rest/dept/tree").then(function(response) {
            ...
            submit: function() {
                ...
                if (!$("#form-member-add").valid())
                    return;
                this.$http.post("${base}/system/rest/dept/add", this.dept, {emulateJSON:true}).then(function(response) {
                    var data = response.data;
                    if ("0000" == data.code) {
